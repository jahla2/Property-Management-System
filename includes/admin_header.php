...
<html lang="en">
    ...
    <script src="./js/sb-admin-2.min.js"></script>
    <script src="./js/sb-admin-2.js"></script>
    <link rel="stylesheet" href="./css_js.php">
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="view_all_record.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>View All Records</span></a>
            </li>

            <li class="nav-item">
                <a href="add_new_record.php" class="nav-link">
                    <i class="fas fa-fw fa-plus"></i> 
                    <!-- <i class="fa-solid fa-file-plus-minus"></i> -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> <b><?php echo $_SESSION['username']; ?></b></span>
